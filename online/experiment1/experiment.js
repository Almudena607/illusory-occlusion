...
var researcher_email = "A.RamirezHaro3@westernsydney.edu.au" //(X@student.westernsydney.edu.au)
...
if (Math.random()<.5) {
    var taskdescription = "[z] biological or non-biological [m]"
} else {
    var taskdescription = "[z] non-biological or biological [m]"
}
...
var preload = {
    type: jsPsychPreload,
    images: stimuli.concat(['fixation0.png']),
...
var instr = {
    type: jsPsychHtmlButtonResponse,
    stimulus: "In this experiment, you will see images of animals and objects."+
        "<br />Your task is to classify the images as "+taskdescription+
        "<br />Do not think too much, and go with your first impression.",
    choices: ['continue'],
    post_trial_gap: 500,
}
timeline.push(instr)
...
var instr = {
    type: jsPsychHtmlButtonResponse,
    stimulus: "In the experiment, the images will be shown briefly."+
...
for (var trialnr=0; trialnr<ntrials; trialnr++) { 
    ...
    var trial = {
        ...
        choices: ['z','m'],
        prompt: "<br /><br /><br /><br /><br />"+taskdescription,
        trial_duration: 500,
        data: {trialnr:trialnr,test_part:'fix',stim:stim,task:taskdescription},
    }
    timeline.push(trial)
    var trial = {
        type: jsPsychHtmlKeyboardResponse,
        ...
        prompt: "<br /><br /><br /><br /><br />"+taskdescription,
        trial_duration: 100,
        data: {trialnr:trialnr,test_part:'stim',stim:stim,task:taskdescription},
        on_finish: function(){
    ...
    var trial = {
        ...
        post_trial_gap: 500,
        data: {trialnr:trialnr,test_part:'response',stim:stim,task:taskdescription},
        on_finish: function(){
            var count = jsPsych.data.get().filter({test_part: 'stim'}).count()
            jsPsych.setProgressBar(count/ntrials)
        }
